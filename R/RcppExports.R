...
censoring_impl <- function(data, thr_or_null, uncertain_or_null, missing_or_null, sigmas, nns_or_null, callback) {
    .Call('destiny_censoring_impl', PACKAGE = 'destiny', data, thr_or_null, uncertain_or_null, missing_or_null, sigmas, nns_or_null, callback)
}
